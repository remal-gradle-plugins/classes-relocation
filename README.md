...
**Tested on Gradle versions from <!--property:gradle-api.min-version-->7.5<!--/property--> to <!--property:gradle-api.max-version-->9.3.0-rc-3<!--/property-->.**
...
```groovy
plugins {
    id 'name.remal.classes-relocation' version '2.1.6'
}
```
<!--/plugin-usage-->
